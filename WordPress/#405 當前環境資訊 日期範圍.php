...
<body>
    ...
    <div id="container7" style="width: 100%;"></div>

       <script type="text/javascript">
        function fetchData() {
            $.ajax({
                url: '/topics/fetch_date_data.php',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    chart1.series[4].setData(data.scd40_tempData);
                    ...
                    chart2.series[3].setData(data.scd40_humdData);
                    ...
                    chart7.series[0].setData(data.scd40_co2Data); // Add scd40_co2 data to chart6
        ...
        series: [{
            name: 'SCD40 CO2',
            data: [] // You can set the initial data to an empty array or load it later with fetchData()
        }]
    });
